...
from numpy import *
from models import NeighborSamplingGCN,NeighborSamplingGCN1
num_run=10
...
def main():
    ...
    model = NeighborSamplingGCN1(args.model, dataset.num_features,args.hidden, dataset.num_classes, args.binarize,
